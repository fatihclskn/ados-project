...
type PazarlamaPanosuHeaderProps = {
  breadcrumb?: string;
  onOpenSidebar?: () => void;
};
...
export default function PazarlamaPanosuHeader({ breadcrumb = 'Pazarlama · Genel Bakış', onOpenSidebar }: PazarlamaPanosuHeaderProps) {
  return (
    <header className="h-12 bg-white dark:bg-[#111113] border-b border-gray-200 dark:border-gray-800 flex items-center gap-3 px-4 shrink-0">
      ...
      <span className="flex-1 text-[12px] text-gray-500 dark:text-gray-400" id="bc">{breadcrumb}</span>
