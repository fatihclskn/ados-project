...
export default function Header({
  breadcrumb = 'Genel Müdür · Komuta Merkezi',
  clockLabel = '23 Nis 2026 · 09:42',
  onOpenSidebar,
  onJennyQuick,
}: HeaderProps) {
  return (
    <header className="h-12 bg-white dark:bg-[#17181f] border-b border-gray-200 dark:border-gray-600/50 flex items-center gap-3 px-4 shrink-0">
      ...
      >
        ...
        <span className="text-[10px] text-amber-600/70 dark:text-amber-400/70 group-hover:opacity-100 opacity-70">
          AI CEO
        </span>
      </button>
